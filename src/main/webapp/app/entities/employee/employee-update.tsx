  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="semasDoisApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="semasDoisApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('semasDoisApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('semasDoisApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('semasDoisApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('semasDoisApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('semasDoisApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('semasDoisApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('semasDoisApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('semasDoisApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('semasDoisApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
