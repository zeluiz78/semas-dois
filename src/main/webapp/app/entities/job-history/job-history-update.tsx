  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="semasDoisApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="semasDoisApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('semasDoisApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('semasDoisApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('semasDoisApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('semasDoisApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="job-history-job" name="job" data-cy="job" label={translate('semasDoisApp.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('semasDoisApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('semasDoisApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
