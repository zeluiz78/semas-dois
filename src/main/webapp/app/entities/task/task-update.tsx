  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="semasDoisApp.task.home.createOrEditLabel" data-cy="TaskCreateUpdateHeading">
            <Translate contentKey="semasDoisApp.task.home.createOrEditLabel">Create or edit a Task</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('semasDoisApp.task.title')} id="task-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('semasDoisApp.task.description')}
                id="task-description"
                name="description"
                data-cy="description"
                type="text"
              />
              <ValidatedField label={translate('semasDoisApp.task.job')} id="task-job" data-cy="job" type="select" multiple name="jobs">
                <option value="" key="0" />
                {jobs
