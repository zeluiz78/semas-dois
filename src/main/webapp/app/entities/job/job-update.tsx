  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="semasDoisApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="semasDoisApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('semasDoisApp.job.jobTitle')}
                id="job-jobTitle"
                name="jobTitle"
                data-cy="jobTitle"
                type="text"
              />
              <ValidatedField
                label={translate('semasDoisApp.job.minSalary')}
                id="job-minSalary"
                name="minSalary"
                data-cy="minSalary"
                type="text"
              />
              <ValidatedField
                label={translate('semasDoisApp.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              />
              <ValidatedField label={translate('semasDoisApp.job.task')} id="job-task" data-cy="task" type="select" multiple name="tasks">
                <option value="" key="0" />
                {tasks
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('semasDoisApp.job.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
